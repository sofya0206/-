...
export const clients = sqliteTable("clients", {
  ...
  subsequentResponseMinutes: integer("subsequent_response_minutes").notNull().default(0),
  services: text("services").notNull().default(""),
  chatAnalysisStatus: text("chat_analysis_status").notNull().default("not_connected"),
